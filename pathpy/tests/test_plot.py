...
# Time-stamp: <Wed 2021-04-21 09:20 juergen>
#
...
#     tn.add_edge('a', 'b', t=1, color='red', size=4)
#     tn.add_edge('b', 'a', t=3, color='blue')
#     tn.add_edge('b', 'c', t=3, color='green')
#     tn.add_edge('d', 'c', t=4, color='orange')
#     tn.add_edge('c', 'd', t=5, color='yellow')
#     tn.add_edge('c', 'b', t=6, color='black')
#     tn.add_edge('a', 'b', t=7, color='gray', size=8)
#     tn.add_edge('b', 'a', t=8, color='white')

#     # print('-------')
#     # print(tn.nodes['a'].attributes.to_frame(history=True))
#     # print(tn.edges['a', 'b'].attributes.to_frame(history=True))
