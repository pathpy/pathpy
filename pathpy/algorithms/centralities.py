...
def closeness_centrality(network: BaseNetwork, normalized: bool = False) -> Dict:
    ...
    .. note::
        ...
        If `normalized=False` (Default) for each node v the closeness 
        centrality is given as 1/sum_w(dist(v,w)) where 
...
def degree_centrality(network: BaseNetwork, mode: str='degree') -> Union[Dict, None]:
    ...
    Parameters
        ...
        mode : str
            ...
            Can be chose nas 'degree', 'indegree', or 'outdegree'. Determines whether to 
            calculate undirected/total degrees, indegrees, or degrees
...
def rank_centralities(centralities):
    ...
    ----------
    centralities: dict
        dictionary of centralities, e.g. generated by `closeness_centralities`, `betweenness_centralities`,
        or `degree_centralities`.
